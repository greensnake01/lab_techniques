...
dataframe = data_clean # data_clean or data_clean_sqrt or data_clean_log
...
```{r}
box_plots <- list()
for (variable in c(10,27:29,31:38,55:63)){ # all 7:length(variables)
...
export_data_excel <- write.xlsx(export_data, 
                               file = paste0(path, "Data/stats_results_C_N.xlsx"), 
                               sheetName = "stat_test", 
                               rowNames = F,
                               overwrite = T)
```
